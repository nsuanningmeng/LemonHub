...
func InitOptionMap() {
	...
	common.OptionMap["AffRechargeCommissionPercent"] = strconv.FormatFloat(common.AffRechargeCommissionPercent, 'f', -1, 64)
	...
	common.OptionMap["ErrorOverrideGlobalEnabled"] = strconv.FormatBool(operation_setting.ErrorOverrideGlobalEnabled)
	common.OptionMap["ErrorOverrideGlobalMessage"] = operation_setting.ErrorOverrideGlobalMessage
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || strings.HasSuffix(key, "SMTPForceAuthLogin") || strings.HasSuffix(key, "SMTPInsecureSkipVerify") {
		...
		case "ErrorOverrideGlobalEnabled":
			operation_setting.ErrorOverrideGlobalEnabled = boolValue
	...
	case "AffRechargeCommissionPercent":
		if v, err := strconv.ParseFloat(strings.TrimSpace(value), 64); err == nil {
			...
			common.AffRechargeCommissionPercent = v
		}
	...
	case "ErrorOverrideGlobalMessage":
		operation_setting.ErrorOverrideGlobalMessage = value
