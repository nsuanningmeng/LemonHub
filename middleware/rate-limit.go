...
// redisRateLimiter enforces a per-IP fixed window backed by Redis. failOpen decides
// what an INTERNAL error (Redis unreachable, corrupt reply) does: fail-closed
