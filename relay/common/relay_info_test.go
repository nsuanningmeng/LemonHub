...
func TestRelayInfoPublicResponseModelKeepsMappedModelPrivate(t *testing.T) {
	info := &RelayInfo{
	...
	assert.Equal(t, "client-model", info.PublicResponseModelName("provider-response-model"))
	rewritten, err := info.RewriteModelForPublicResponse(
		[]byte(`{"model":"private-upstream-model","response":{"model":"private-upstream-model"},"session":{"model":"private-upstream-model"},"item":{"model":"private-upstream-model"},"provider_extension":7}`),
		"model",
		"response.model",
		"session.model",
		"item.model",
	...
	assert.JSONEq(t, `{"model":"client-model","response":{"model":"client-model"},"session":{"model":"client-model"},"item":{"model":"client-model"},"provider_extension":7}`, string(rewritten))
