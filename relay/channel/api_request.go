...
func DoApiRequest(a Adaptor, c *gin.Context, info *common.RelayInfo, requestBody io.Reader) (*http.Response, error) {
	...
	logger.LogDebug(c, "fullRequestURL: %s", common.SanitizeUpstreamURLForLog(fullRequestURL))
...
func DoWssRequest(a Adaptor, c *gin.Context, info *common.RelayInfo, requestBody io.Reader) (*websocket.Conn, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("dial failed to %s: %w", common.SanitizeUpstreamURLForLog(fullRequestURL), err)
	}
	// send request body
...
func doRequest(c *gin.Context, req *http.Request, info *common.RelayInfo) (*http.Response, error) {
	...
	if err != nil {
		logger.LogError(c, "do request failed: "+upstreamRequestErrorForLog(err))
...
// upstreamRequestErrorForLog strips url.Error's request URL before logging.
// Relay query authentication may use an arbitrary parameter name, so the URL
// wrapper is not safe to persist even when known credential names are masked.
func upstreamRequestErrorForLog(err error) string {
	if err == nil {
		return ""
	}
