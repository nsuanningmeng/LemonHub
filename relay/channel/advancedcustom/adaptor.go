...
// Cross-protocol streams report usage in their own format, so request upstream
// usage even though the incoming protocol does not expose Chat stream_options.
