...
import type { AffAdminSortColumn, AffAdminSortOrder } from '../types'
...
// rank + name + 6 right-aligned numeric cells.
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className='text-right'>{t('Total Invited')}</TableHead>
